...
CXXFLAGS += -Wall -Wextra -Wpedantic -Werror -Wno-c99-extensions

# Mandatory ARM SME Flags
CXXFLAGS += -march=armv9.2-a+sve+sme+sme-f64f64 -mcpu=native
...
LDLIBS = -lm -lmemkind -lhwloc -lnuma -L${HBMROOT}/lib -lunwind
